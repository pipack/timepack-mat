...
classdef FAD2d < Problem
    ...
    methods
            ...
            switch this.splitting
                case 1 % -- forcing paired with advection -------------------------------------------------------------- 
                    switch part
                        ...
                        case 2 % --> second component (ADVECTION)
                            up = this.UxUy_operator * u + this.forcingFunction(u(end));
                    end
                case 2 % -- forcing paired with diffusion -------------------------------------------------------------- 
                    switch part
                        ...
                        case 2 % --> second component (ADVECTION)
                            up = this.UxxUyy_operator * u + this.forcingFunction(u(end));
                    end
            end
        ...
        function F = forcingFunction(this, t)
            ...
            -2).*pi.*(1+2.*t).*((-1)+x+y).*delta.*sin(2.*pi.*(1+2.*t).*((-1).*y+ ...
            x.*((-1)+2.*y)));
        ...
        function JFF = JForcingFunction(this, t)
            ...
            data = (-8).*pi.^2.*(1+2.*t).*((-1)+x).*x.*((-1)+y).*cos(2.*pi.*(1+2.*t) ...
            .*x.*((-1)+y)).*cos(2.*pi.*(1+2.*t).*((-1)+x).*y)+(-8).*pi.^2.*(1+ ...
            2.*t).*((-1)+x).*x.*y.*cos(2.*pi.*(1+2.*t).*x.*((-1)+y)).*cos(2.* ...
            pi.*(1+2.*t).*((-1)+x).*y)+(-8).*pi.^2.*(1+2.*t).*((-1)+x).*((-1)+ ...
            y).*y.*cos(2.*pi.*(1+2.*t).*x.*((-1)+y)).*cos(2.*pi.*(1+2.*t).*(( ...
            -1)+x).*y)+(-8).*pi.^2.*(1+2.*t).*x.*((-1)+y).*y.*cos(2.*pi.*(1+ ...
            2.*t).*x.*((-1)+y)).*cos(2.*pi.*(1+2.*t).*((-1)+x).*y)+32.*pi.^2.* ...
            ((-1)+x).*x.*((-1)+y).*y.*cos(2.*pi.*(1+2.*t).*x.*((-1)+y)).*cos( ...
            2.*pi.*(1+2.*t).*((-1)+x).*y)+16.*pi.*(pi+2.*pi.*t).*epsilon.*(cos(2.* ...
            pi.*(1+2.*t).*(x+(-1).*y))+((-1)+2.*x+(-2).*x.^2+2.*y+(-2).*y.^2) ...
            .*cos(2.*pi.*(1+2.*t).*((-1).*y+x.*((-1)+2.*y))))+(-4).*pi.*((-1)+ ...
            x).*cos(2.*pi.*(1+2.*t).*((-1)+x).*y).*sin(2.*pi.*(1+2.*t).*x.*(( ...
            -1)+y))+(-4).*pi.*y.*cos(2.*pi.*(1+2.*t).*((-1)+x).*y).*sin(2.* ...
            pi.*(1+2.*t).*x.*((-1)+y))+(-4).*pi.*x.*cos(2.*pi.*(1+2.*t).*x.*(( ...
            -1)+y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).*y)+(-4).*pi.*((-1)+y).* ...
            cos(2.*pi.*(1+2.*t).*x.*((-1)+y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).* ...
            y)+8.*pi.^2.*(1+2.*t).*x.^2.*((-1)+y).*sin(2.*pi.*(1+2.*t).*x.*(( ...
            -1)+y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).*y)+8.*pi.^2.*(1+2.*t).*x.* ...
            ((-1)+y).^2.*sin(2.*pi.*(1+2.*t).*x.*((-1)+y)).*sin(2.*pi.*(1+2.* ...
            t).*((-1)+x).*y)+(-16).*pi.^2.*x.^2.*((-1)+y).^2.*sin(2.*pi.*(1+ ...
            2.*t).*x.*((-1)+y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).*y)+8.*pi.^2.*( ...
            1+2.*t).*((-1)+x).^2.*y.*sin(2.*pi.*(1+2.*t).*x.*((-1)+y)).*sin( ...
            2.*pi.*(1+2.*t).*((-1)+x).*y)+8.*pi.^2.*(1+2.*t).*((-1)+x).*y.^2.* ...
            sin(2.*pi.*(1+2.*t).*x.*((-1)+y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).* ...
            y)+(-16).*pi.^2.*((-1)+x).^2.*y.^2.*sin(2.*pi.*(1+2.*t).*x.*((-1)+ ...
            y)).*sin(2.*pi.*(1+2.*t).*((-1)+x).*y)+4.*(pi+2.*pi.*t).^2.*epsilon.*(( ...
            -4).*pi.*(x+(-1).*y).*sin(2.*pi.*(1+2.*t).*(x+(-1).*y))+(-4).*pi.* ...
            ((-1)+2.*x+(-2).*x.^2+2.*y+(-2).*y.^2).*((-1).*y+x.*((-1)+2.*y)).* ...
            sin(2.*pi.*(1+2.*t).*((-1).*y+x.*((-1)+2.*y))));
